              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@switchtostyle.com</p>
                    <p className="text-gray-600">support@switchtostyle.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mt-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">We offer a 30-day return policy for all unworn items in original packaging.</p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900">Do you offer international shipping?</h3>
        ...
        <div className="mt-12 bg-white rounded-lg shadow-md overflow-hidden">
          <div className="h-64 bg-gray-200 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">123 Fashion Street, Style City, SC 12345</p>
            </div>
          </div>
        </div>
      </div>
